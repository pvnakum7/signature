...
//  Permission _permission = Permission.WriteExternalStorage;
  ...
  initPlatformState() async {
    ...
    try {
      requestPermission();
      checkPermission();
      bool pstaeus = getPermissionStatus();


//      /Map<PermissionGroup, PermissionStatus> permissions = await PermissionHandler().requestPermissions([PermissionGroup.storage]);
//
//       permission = await PermissionHandler().checkPermissionStatus(PermissionGroup.storage);
//       serviceStatus = await PermissionHandler().checkServiceStatus(PermissionGroup.location);
//      print(" $serviceStatus");
...
//    print(_platformVersion);
  ...
  requestPermission() async {
    Map<PermissionGroup, PermissionStatus> spermissions = await PermissionHandler().requestPermissions([PermissionGroup.storage]);
...
//    final result = await SimplePermissions.getPermissionStatus(_permission);
    ...
    print("permission status is ----->" + serviceStatus.toString());
  }
